...
plot_heatmap(
  heatmap_definition,
  annotated_degs,
  go_terms_phosphorylation,
  filter_by = 'GOterm',
  filter_fn = mock_vs_inf_filter,
  filename = 'results/heatmaps/phosphorylation.pdf'
)
...
plot_heatmap(
  ...
  filter_by = 'GOterm',
  filter_fn = mock_vs_inf_filter,
  filename = 'results/heatmaps/hormones.pdf'
)

# R genes
tol_vs_duke_filter <- function(x) {
